...
qiinfo <- qiinfo %>%
  mutate(
    ...
    qiname = case_when(
      ...
      qivar == "qi_ras" ~ "prescribed ACEI/ARB/ARNI in patients with HFrEF (LVEF <40%)",
      qivar == "qi_arni" ~ "prescribed ARNI in patients with HFrEF (LVEF <40%)",
      qivar == "qi_bbl" ~ "prescribed beta-blocker in patients with HFrEF (LVEF <40%)",
      qivar == "qi_mra" ~ "prescribed MRA in patients with HFrEF (LVEF <40%)",
      qivar == "qi_4" ~ "prescribed quadruple therapy in patients with HFrEF (LVEF <40%)",
      qivar == "qi_sglt2_ref" ~ "prescribed SGLT2 inhibitor in patients with HFrEF (LVEF <40%)",
      qivar == "qi_sglt2_mref" ~ "prescribed SGLT2 inhibitor in patients with HFmrEF (LVEF 40-49%)",
      qivar == "qi_sglt2_pef" ~ "prescribed SGLT2 inhibitor in patients with HFpEF (LVEF >=50%)",
    ...
    qino = case_when(
      ...
      qivar == "qi_mra" ~ 11,
      qivar == "qi_4" ~ 7,
      qivar == "qi_sglt2_ref" ~ 12,
      qivar == "qi_sglt2_mref" ~ 13,
      qivar == "qi_sglt2_pef" ~ 14,
      qivar == "qi_crt" ~ 15,
      qivar == "qi_icd" ~ 16,
      qivar == "qi_fys" ~ 17,
