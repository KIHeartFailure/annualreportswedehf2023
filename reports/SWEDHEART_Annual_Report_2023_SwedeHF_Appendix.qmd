...
COVERAGE AVAILABLE IN APRIL 2024.
...
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0("Trends in ", qinametmp, ", ", global_year - 5, "-", global_year)
#| fig-height: 7
#| fig-width: 9
#| out-width: "50%"
#| out-height: "50%"
...
#| fig-subcap: !expr c(paste0(global_year - 5, "-", global_year), paste0(global_year - 2, "-", global_year, ", Sweden"), paste0(global_year - 2, "-", global_year, ", Hospital"), paste0(global_year - 2, "-", global_year, ", Primary care"))
#| fig-height: 7
#| fig-width: 9
#| layout-nrow: 2
#| layout-ncol: 2
