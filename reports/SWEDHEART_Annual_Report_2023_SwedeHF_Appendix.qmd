...
The information presented is based on data reported in SwedeHF until 31st of January 2024. 
...
https://github.com/KIHeartFailure/swedehf-annualreport-2023. 
...
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0("Centre type by county, ", global_year)
#| fig-subcap:
#|   - At index
#|   - All registrations
#| layout-ncol: 2
...
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0("Trends in ", qinametmp, ", ", global_year - 6, "-", global_year)
#| fig-height: 7
#| fig-width: 9
#| out-width: "50%"
#| out-height: "50%"
...
*In the figure `r paste0("Trends in ", qinametmp, ", ", global_year - 6, "-", global_year)` only index registrations until `r paste0(global_year, "-07-01")` are included in `r global_year`. In other presentations the time interval for the index is `r paste0(global_year - 1, "-07-01 - ", global_year, "-07-01")`.*
...
#| fig-subcap: !expr c(paste0(global_year - 6, "-", global_year), paste0(global_year - 2, "-", global_year, ", Sweden"), paste0(global_year - 2, "-", global_year, ", Hospital"), paste0(global_year - 2, "-", global_year, ", Primary care"))
#| fig-height: 7
#| fig-width: 9
#| layout-nrow: 2
#| layout-ncol: 2
...
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0(firstcap(qinametmp), " by county, ", global_year)
#| fig-subcap:
#|   - 'Index'
#|   - '3-month follow-up'
#|   - '1-year follow-up'
