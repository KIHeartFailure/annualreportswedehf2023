```{r allki, cache=cacheon, fig.cap=, fig.width=9, fig.height=6}
#| label: fig-allki
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0("Sweden, all ", nrow(qiinfo), " quality indicators ",  global_year)
#| fig-height: 6
#| fig-width: 10
#| out-width: "125%"
#| out-height: "125%"
...
arrows(b[25], posarrow, b[34] - adjmin, posarrow, xpd = TRUE, code = 2, length = 0.1)
