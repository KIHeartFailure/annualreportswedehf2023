```{r allki-sv, cache=cacheon, fig.cap=, fig.width=9, fig.height=6}
#| label: fig-allki
#| cache: true
#| cache.comments: false
#| fig-cap: !expr paste0("Riket, alla ", nrow(qiinfo), " kvalitetsindikatorer ",  global_year)
#| fig-height: 6
#| fig-width: 10
#| out-width: "125%"
#| out-height: "125%"
...
axis(1,
  at = bplace + 0.5,
  labels = qiinfo$qishortname_sv, line = -0.5, tick = FALSE, cex.axis = cexmy, gap.axis = -10000000, las = 2
)
...
arrows(b[26], posarrow, b[34] - adjmin, posarrow, xpd = TRUE, code = 2, length = 0.1)
